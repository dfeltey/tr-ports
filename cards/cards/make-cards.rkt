(module make-cards typed/racket
  ...
  (: get-bitmap ((U Path-For-Some-System Path-String 'up 'same) -> (Instance mred:Bitmap%)))
  ...
  (: here ((U Path-For-Some-System Path-String 'up 'same) -> (U Path-For-Some-System Path-String 'up 'same)))
  (define here 
